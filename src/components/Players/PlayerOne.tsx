...
const PlayerOne = ({ score, current, isActive, isWinner }: PlayerProps) => {
  return (
    <div
      className={`w-[100%] flex justify-center items-center flex-col rounded-bl-[10px] rounded-tl-[10px] 
      ${isWinner ? "bg-black" : isActive ? "bg_one" : "bg_two"}`}
    >
      <h1 className="text-[40px] mt-[70px] mb-5">PLAYER 1</h1>
